        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full '>
                ...
                <p className=' text-gray-500 py-4 max-w-md '>
                    I have wfneiufjcnewiunciuewcnierjvnurbhnc  
                    wuiervichw  wfniuwnfiernc ui  fwninwi ufn wfneiufjcnewiunciuewcnierjvnurbhnc
                    fwuifh weufiuehwfinwe  wfwff
                    wfnweinciuenbi  fiwenfewinv
                    wnfiwej 

                    wf wfneiufjcnewiunciuewcnierjvnurbhnc
                </p>
